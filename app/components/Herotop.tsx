      ...
      <div className="max-w-[1200px] mx-auto">
        <div className=" text-center">
          <div className="max-w-5xl mx-auto">
            <span
              className="inline-flex items-center mb-6 rounded-md font-medium 
            forced-colors:outline bg-orange-500/15 text-text_primary 
            group-data-[hover]:bg-orange-500/25 dark:bg-orange-500/10 
            dark:text-orange-400 dark:group-data-[hover]:bg-orange-500/20 
            px-1.5 py-0.5 text-sm/5 sm:text-[16px] gap-x-1.5"
            >
              Decouvrez +750 IA ⚡️
            </span>
            <h1
            ...
            >
              <b className="relative inline-block">
                ...
                <span className="relative z-10 ">Explorez</span>
              </b>{" "}
              et{" "}
              <b className="relative inline-block">
                <svg
                  className="absolute z-0 h-[100%] w-[calc(100%+1rem)] fill-text_primary"
                  xmlns="http://www.w3.org/2000/svg"
                  width="223"
                  height="62"
                  viewBox="0 0 223 62"
                ...
                <span className="relative z-10">Exploitez</span>
              </b>{" "}
              l'IA
            </h1>
          </div>
